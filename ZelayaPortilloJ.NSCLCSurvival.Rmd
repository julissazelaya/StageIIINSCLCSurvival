...
```{r exploration_categorical_frequency}
...
```{r exploration_target_frequency, warning=FALSE, message=FALSE}
...
```{r exploration_correlation_scatterplot}
...
```{r cleaning_missing_imputation, include = FALSE, warning=FALSE}
...
```{r cleaning_collinearity_interaction}
...
```{r cleaning_transformation_hist}
...
```{r evaulation_holdout_log, warning=FALSE, message=FALSE}
# Reproducibility
set.seed(123)
...
```{r evaluation_holdout_knn, message=FALSE}
...
```{r evaluation_holdout_svm, message=FALSE}
...
```{r evaluation_kfold_log, warning=FALSE}
# Reproducibility
set.seed(123)
...
```{r evaluation_kfold_svm, warning=FALSE}
